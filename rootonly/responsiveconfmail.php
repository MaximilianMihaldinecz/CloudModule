...
//Sends a responsive email to a recipient
//The responsive template is based on the "Foundations for Emails" project: http://foundation.zurb.com/emails.html
//The message of the email has three main parts:
//Welcome: e.g. "Welcome Jo"
//Headline: One sentence, the summary/key message of the email
//Body section: Main content of the email in HTML format
function sendresponsiveconfmail($welcomemsg, $headline, $bodysection, $to, $subject)
{
                            ...
                            <tbody >
                              <tr >
                                <th class="small-6 large-6 columns first" valign = "middle" >
                                  <table >
                                    <tr >
                                      <p class="text-left" > Greathosting . com</p >
                                    </tr >
                                  </table >
                                </th >
                                  ...
                                  <table >
                                    <tr >
                                      <th >
                                        <h5 >Contact Info:</h5 >
                                        <p >Phone: 123456789 </p >
                                        <p >Email: <a href = "mailto:contact@greath0sting.com" >contact@greath0sting.com</a ></p >
                                      </th >
                                    </tr >
                                  </table >
                                </th >
